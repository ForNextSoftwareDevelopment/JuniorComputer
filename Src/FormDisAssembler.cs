...
namespace JuniorComputer
{
    public partial class FormDisAssembler : Form
    {
        ...
        private void FormDisAssembler_Load(object sender, EventArgs e)
        {
            ...
            disAssembler = new DisAssembler(bytes, loadAddress, startAddress, useLabels);
            program = disAssembler.Parse();
            richTextBoxProgram.Text = disAssembler.linedprogram;
        ...
        private void btnAddExeAddress_Click(object sender, EventArgs e)
        {
            ...
            program = disAssembler.Parse(exeAddress);
            richTextBoxProgram.Text = disAssembler.linedprogram;
